...
(\Pinga\Cookie\Session::id() === '') or \fail(__LINE__);

\Pinga\Cookie\Session::start();
$sessionCookieReferenceHeader = \Pinga\Http\ResponseHeader::take('Set-Cookie');
session_write_close();

\Pinga\Cookie\Session::start(null);
...
$oldSessionId = \Pinga\Cookie\Session::id();
\Pinga\Cookie\Session::regenerate();
(\Pinga\Cookie\Session::id() !== $oldSessionId) or \fail(__LINE__);
(\Pinga\Cookie\Session::id() !== null) or \fail(__LINE__);

\session_unset();

(isset($_SESSION['key1']) === false) or \fail(__LINE__);
(\Pinga\Cookie\Session::has('key1') === false) or \fail(__LINE__);
(\Pinga\Cookie\Session::get('key1') === null) or \fail(__LINE__);
(\Pinga\Cookie\Session::get('key1', 5) === 5) or \fail(__LINE__);
(\Pinga\Cookie\Session::get('key1', 'monkey') === 'monkey') or \fail(__LINE__);

\Pinga\Cookie\Session::set('key1', 'value1');

(isset($_SESSION['key1']) === true) or \fail(__LINE__);
(\Pinga\Cookie\Session::has('key1') === true) or \fail(__LINE__);
(\Pinga\Cookie\Session::get('key1') === 'value1') or \fail(__LINE__);
(\Pinga\Cookie\Session::get('key1', 5) === 'value1') or \fail(__LINE__);
(\Pinga\Cookie\Session::get('key1', 'monkey') === 'value1') or \fail(__LINE__);

(\Pinga\Cookie\Session::take('key1') === 'value1') or \fail(__LINE__);
(\Pinga\Cookie\Session::take('key1') === null) or \fail(__LINE__);
(\Pinga\Cookie\Session::take('key1', 'value2') === 'value2') or \fail(__LINE__);
(isset($_SESSION['key1']) === false) or \fail(__LINE__);
(\Pinga\Cookie\Session::has('key1') === false) or \fail(__LINE__);

\Pinga\Cookie\Session::set('key2', 'value3');

(isset($_SESSION['key2']) === true) or \fail(__LINE__);
(\Pinga\Cookie\Session::has('key2') === true) or \fail(__LINE__);
(\Pinga\Cookie\Session::get('key2', 'value4') === 'value3') or \fail(__LINE__);
\Pinga\Cookie\Session::delete('key2');
(\Pinga\Cookie\Session::get('key2', 'value4') === 'value4') or \fail(__LINE__);
(\Pinga\Cookie\Session::get('key2') === null) or \fail(__LINE__);
(\Pinga\Cookie\Session::has('key2') === false) or \fail(__LINE__);
